...
**Goal**: Execute maximum parallel work for {{DOMAIN}} while maintaining a clean, simple interface to the main thread. The complexity of parallel execution should be invisible above you.
