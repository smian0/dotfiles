...
alias -- glm=/Users/smian/.glm/local/glm
alias -- glmdsp='glm --dangerously-skip-permissions'
alias -- glmdspr='glm --dangerously-skip-permissions --resume'
alias -- grep='grep --color=auto'
alias -- kimi=/Users/smian/.kimi/local/kimi
alias -- kimidsp='kimi --dangerously-skip-permissions'
alias -- kimidspr='kimi --dangerously-skip-permissions --resume'
alias -- ll='ls -la'
alias -- ls='ls -G'
alias -- pip=pip3
...
if ! command -v rg >/dev/null 2>&1; then
  alias rg='/Users/smian/.nvm/versions/node/v20.19.1/lib/node_modules/\@anthropic-ai/claude-code/vendor/ripgrep/arm64-darwin/rg'
fi
export PATH='/Users/smian/github/agno/libs/agno/.venv/bin:/Users/smian/.pyenv/shims:/Users/smian/.claude/local:/Users/smian/.kimi/local:/Users/smian/.glm/local:/opt/homebrew/opt/ruby/bin:/Users/smian/.nvm/versions/node/v20.19.1/bin:/opt/homebrew/Caskroom/miniconda/base/condabin:/opt/homebrew/opt/tcl-tk@8/bin:/Users/smian/.codeium/windsurf/bin:/Users/smian/.bun/bin:/opt/homebrew/opt/postgresql@16/bin:/Users/smian/.codeium/windsurf/bin:/Users/smian/.local/bin:/opt/homebrew/bin:/opt/homebrew/sbin:/usr/local/bin:/System/Cryptexes/App/usr/bin:/usr/bin:/bin:/usr/sbin:/sbin:/var/run/com.apple.security.cryptexd/codex.system/bootstrap/usr/local/bin:/var/run/com.apple.security.cryptexd/codex.system/bootstrap/usr/bin:/var/run/com.apple.security.cryptexd/codex.system/bootstrap/usr/appleinternal/bin:/Library/Apple/usr/bin:/Applications/Little Snitch.app/Contents/Components:/Users/smian/.cargo/bin:/Users/smian/.cursor/extensions/ms-python.debugpy-2025.8.0-darwin-arm64/bundled/scripts/noConfigScripts:/opt/homebrew/opt/fzf/bin:/Users/smian/.cache/lm-studio/bin:/Users/smian/development/flutter/bin'
