...
def main():
    ...
    - [ ] Account has ${selected_data['recommended_put']['strike'] * 100:.0f} in cash to secure put
    - [ ] Checked earnings date (avoid selling puts before earnings)
    - [ ] Bid/ask spread is acceptable ({selected_data['recommended_put']['spread_pct']:.1f}%)
    - [ ] Ready to use limit order at mid-price (${selected_data['recommended_put']['premium']:.2f})
    - [ ] Position sizing appropriate (< 10% of portfolio)
    - [ ] Happy to own {selected_ticker} at ${selected_data['recommended_put']['strike']:.0f}?
